...
class AzkarSabah extends StatelessWidget {
  static const String routeName = 'sabah';
  List<Widget> Zekr = [
    ZekrWidget(
      1,
    ...
    ZekrWidget(1,
        'اللَّهُمَّ إِنِّي أَسْأَلُكَ عِلْمًا نَافِعًا، وَرِزْقًا طَيِّبًا، وَعَمَلًا مُتَقَبَّلًا.ُ'),
    ZekrWidget(
        1,
    ...
    ZekrWidget(100, 'أسْتَغْفِرُ اللهَ وَأتُوبُ إلَيْهِ '),
  ];
